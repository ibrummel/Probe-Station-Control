...
class CapFreqTempWidget(CapFreqWidget):
    ...
    #     super(CapFreqTempWidget, self).update_live_readout(data)
...
class CapFreqTempMeasureWorkerObject(CapFreqMeasureWorkerObject):
    ...
    def __init__(self, parent: CapFreqTempWidget):
        super(CapFreqTempWidget, self).__init__(parent)
        # self.parent = parent
        # self.step_temp = None
        # self.user_avg = 0
        # self.chamber_avg = 0
    ...
    #     super(CapFreqTempWidget, self).set_test_params(row)
    ...
    #     super(CapFreqTempWidget, self).set_current_meas_labels()
    ...
    #     super(CapFreqTempWidget, self).blocking_func()
